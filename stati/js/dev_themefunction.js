...
jQuery(document).on('ready', function() {
	...
	if(jQuery('#listar-relatedlistingslider1').length > 0){
		var _listar_relatedlistingslider = jQuery('#listar-relatedlistingslider1');
		_listar_relatedlistingslider.owlCarousel({
			items: 3,
			nav:true,
			loop:true,
	...
	if(jQuery('#listar-relatedlistingslider2').length > 0){
		var _listar_relatedlistingslider = jQuery('#listar-relatedlistingslider2');
		_listar_relatedlistingslider.owlCarousel({
			items: 6,
			nav:true,
			loop:true,
